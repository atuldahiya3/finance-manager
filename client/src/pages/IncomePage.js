...
const IncomePage = () => {
  ...
  const handleAddCategory = async () => {
    ...
    try {
      ...
      const res = await axios.post('/api/income/categories', payload);
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex space-x-3">
          ...
          <Button 
            ...
            className="bg-gray-800 rounded-xl text-black px-4 py-2 shadow hover:bg-primary-600 focus:ring-2 focus:ring-primary-300"
          >
